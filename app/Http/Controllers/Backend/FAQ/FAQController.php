...
class FAQController extends Controller
{
    ...
    {
        $this->faq->create($request->only('question', 'answer', 'question_ru', 'answer_ru', 'question_it', 'answer_it', 'admin_comment'));
    ...
    {
        $this->faq->update($faq, $request->only('question', 'answer', 'question_ru', 'answer_ru', 'question_it', 'answer_it', 'admin_comment'));
