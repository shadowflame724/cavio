...
trait ProductPriceAttribute
{

    public function getEditButtonAttribute()
    {
        return '<a href="' . route('admin.products.price.edit', ['id' => $this->id]) . '" class="btn btn-xs btn-primary" >' .
    ...
    {
        return '<a href="' . route('admin.products.price.remove', ['id' => $this->id]) . '" ' .
    ...
    {
        return 
        '<a href="' . route('admin.products.price.restore', ['id' => $this->id]).'" name="restore_lien_type" class="btn btn-xs btn-info">' .
    ...
    {
        return 
        '<a href="'.route('admin.products.price.permanent.remove', ['id' => $this->id]).'" name="delete_lien_type_perm" class="btn btn-xs btn-danger">' .
