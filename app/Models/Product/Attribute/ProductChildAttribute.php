...
trait ProductChildAttribute
{

    public function getEditButtonAttribute()
    {
        return '<a href="' . route('admin.products.child.edit', ['id' => $this->id]) . '" class="btn btn-xs btn-primary" >' .
    ...
    {
        return '<a href="' . route('admin.products.child.remove', ['id' => $this->id]) . '" ' .
    ...
    {
        return 
        '<a href="' . route('admin.products.child.restore', ['id' => $this->id]).'" name="restore_lien_type" class="btn btn-xs btn-info">' .
    ...
    {
        return 
        '<a href="'.route('admin.products.child.permanent.remove', ['id' => $this->id]).'" name="delete_lien_type_perm" class="btn btn-xs btn-danger">' .
