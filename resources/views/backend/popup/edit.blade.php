        ...
        <div class="box-body">
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane fade" id="ru">
                    <div class="form-group">
                        {{ Form::label('title_ru', trans('validation.attributes.backend.access.popup.title_ru'), ['class' => 'col-lg-2 control-label']) }}
                    ...
                    <div class="form-group">
                        {{ Form::label('body_ru', trans('validation.attributes.backend.access.popup.body_ru'), ['class' => 'col-lg-2 control-label']) }}
                        <div class="col-lg-10">
                ...
                <div role="tabpanel" class="tab-pane fade" id="it">
                    <div class="form-group">
                        {{ Form::label('title_it', trans('validation.attributes.backend.access.popup.title_it'), ['class' => 'col-lg-2 control-label']) }}
                    ...
                    <div class="form-group">
                        {{ Form::label('body_it', trans('validation.attributes.backend.access.popup.body_it'), ['class' => 'col-lg-2 control-label']) }}
                        <div class="col-lg-10">
