...
@section('page-header')
    <h1>
        ...
        <small>        {{ trans('labels.backend.access.documents.create') }}
        </small>
    </h1>
...
@section('content')
    {!! Form::open(['route' => 'admin.documents.store', 'id' => 'create-doc', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'enctype' => "multipart/form-data"]) !!}
    ...
    <div class="box box-success">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    {{ Form::textarea('link', null, ['id' => 'redactor', 'class' => 'form-control', 'required' => 'required', 'autofocus' => 'autofocus']) }}
                </div><!--col-lg-10-->
            </div><!--form control-->
