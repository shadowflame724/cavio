    ...
    <div class="box box-success">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    {{ Form::email('email', null, ['class' => 'form-control', 'maxlength' => '191', 'autofocus' => 'autofocus']) }}
                </div><!--col-lg-10-->
            </div><!--form control-->
...
@section('after-scripts')
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA_98DZxvQpo3chg09J6Kx_oDpjehC7d7I&callback=initMap" async defer></script>
@endsection
