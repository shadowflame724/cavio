...
@section('page-header')
    ...
    <h1>
        ...
        <small>{{ trans('labels.backend.access.templateMessage.edit') }}</small>
    </h1>
@endsection

@section('content')
    {{ Form::model($templateMessage, ['route' => ['admin.template-messages.update', $templateMessage], 'class' => 'form-horizontal', 'page' => 'form', 'method' => 'PATCH', 'id' => 'edit-templateMessage', 'enctype' => "multipart/form-data"]) }}
    <div class="box">
