...
@section('content')
    {{ Form::model($news, ['route' => ['admin.access.news.update', $news], 'class' => 'form-horizontal', 'page' => 'form', 'method' => 'PATCH', 'id' => 'edit-news', 'enctype' => "multipart/form-data"]) }}
    ...
    <div class="box box-success">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    @if($news->image != null)
                        <img class="cropit-preview" src="/img/backend/news/{{$news->image}}" width="300" height="300">
                    @endif
