...
@section('content')
    {!! Form::open(['route' => 'admin.access.collection.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'enctype' => "multipart/form-data", 'id'=> 'collection-form']) !!}
    ...
    <div class="box box-success">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    {{ Form::text('description', null, ['id'=> 'description', 'class' => 'form-control', 'required' => 'required', 'autofocus' => 'autofocus', 'placeholder' => 'SEO info']) }}
                </div><!--col-lg-10-->
            </div><!--form control-->
...
@section('after-scripts')
    ...
    <script>
        Dropzone.options.myDropzone = {
            url: "{{route('admin.access.collection.store')}}",
