...
@section('content')
    {{ Form::model($category, ['route' => ['admin.access.category.edit', $category], 'class' => 'form-horizontal', 'page' => 'form', 'method' => 'POST', 'id' => 'edit-category', 'enctype' => "multipart/form-data"]) }}
...
@section('after-scripts')
    ...
    {{ Html::script('js/backend/access/category/script.js') }}
