...
{{--<a href="#" class="drop-left-menu-products">{{ trans('frontend.header.products') }} <span--}}
        ...
        {{--<div class="top-menu-block">--}}
            {{--<div class="innet-top-menu-block">--}}
                {{--<a class="top-menu-title"--}}
                   {{--href="{{ route('frontend.catalogue') }}">{{ $category->{'name'.$langSuf} }}</a>--}}
...
{{--<ul class="left-nav">--}}
{{--<li class="drop-item">--}}
{{--<a href="#">{{ trans('frontend.header.collections') }} <span--}}
{{--class="drop-item-arrow">→</span></a>--}}
...
{{--</li>--}}
{{--<li class="drop-item">--}}
{{--<a href="#">{{ trans('frontend.header.zones') }} <span--}}
{{--class="drop-item-arrow">→</span></a>--}}
{{--<ul class="drop-item-menu">--}}
...
{{--<li>--}}
{{--<a href="#"--}}
{{--class="anim-underline light-underline">{{ $zone->{'title'.$langSuf} }}</a>--}}
{{--</li>--}}
{{--@endforeach--}}
{{--</ul>--}}
{{--</div>--}}
...
{{--<li>--}}
{{--<a href="#"--}}
{{--class="anim-underline light-underline">{{ $collection->{'title'.$langSuf} }}</a>--}}
{{--</li>--}}
{{--@endforeach--}}
{{--</ul>--}}
{{--</div>--}}
    ...
    <div class="top-nav container">
        <div class="short-nav">
            <div class="short-nav-item hide">
                <a href="catalogue.html" for="menu-products" class="btn-top-menu anim-underline">products</a>
            </div>
            <div class="short-nav-item hide">
                <a href="zones_collections.html" for="menu-collection"
