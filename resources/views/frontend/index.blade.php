...
<main id="main-scrollbar" data-scrollbar="" tabindex="1" style="overflow: hidden; outline: none;">
    <article class="scroll-content">
        ...
        <section id="new-products">
            <div class="wrap-new-products clearfix">
                ...
                <div class="new-products-right-side bg-white-marmur">
                    <div class="wrap-right-slidebox bg-white-marmur hide disp-none">
                        <div class="new-products-right-item nowrp-item hide"><a
                    ...
                    <div class="wrap-right-slidebox bg-white-marmur hide disp-none">
                        <div class="new-products-right-item nowrp-item hide"><a href="#"
                                                                                class="new-products-right-inner-item">
                                <div class="wrap-new-product-img bg-white-marmur"
                                     style="background-image: url(../../img/frontend/un_banner-1-2.jpg)"></div>
                                <div class="wrap-new-product-data">
                        ...
                        <div class="new-products-right-item nowrp-item hide"><a href="#"
                                                                                class="new-products-right-inner-item">
                                <div class="wrap-new-product-img bg-white-marmur"
                                     style="background-image: url(../../img/frontend/un_banner-1-4.jpg)"></div>
                                <div class="wrap-new-product-data">
                    ...
                    <div class="wrap-right-slidebox bg-white-marmur">
                        <div class="new-products-right-item nowrp-item"><a href="#"
                                                                           class="new-products-right-inner-item">
                                <div class="wrap-new-product-img bg-white-marmur"
                                     style="background-image: url(../../img/frontend/un_banner-1-2.jpg)"></div>
                                <div class="wrap-new-product-data">
                ...
                <div class="wrap-new-products-gradiet"></div>
            </div>
        </section>
                ...
                <div class="wrap-philosophy a clearfix">
                    ...
                    <div class="phil-left">
                        <div class="wrap-img-bg philosophy-img">
                            ...
                            <img src="/upload/images/{!! $page->blocks->get(0)->image !!}" alt=""></div>
                    </div>
    ...
    <aside class="scrollbar-track scrollbar-track-x" style="display: none;">
        <div class="scrollbar-thumb scrollbar-thumb-x"
             style="width: 830px; transform: translate3d(0px, 0px, 0px);"></div>
    </aside>
    <aside class="scrollbar-track scrollbar-track-y" style="display: block;">
        <div class="scrollbar-thumb scrollbar-thumb-y"
             style="height: 87.6288px; transform: translate3d(0px, 0px, 0px);"></div>
    </aside>
