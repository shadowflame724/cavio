...
<meta name=viewport content="width=device-width,initial-scale=1,maximum-scale=1"><title>Web Starter Kit</title>
<meta name=msapplication-tap-highlight content=no>
<link rel=manifest href="manifest.json">
<meta name=mobile-web-app-capable content=yes>
<meta name=application-name content="Web Starter Kit">
<link rel=icon sizes=192x192 href="http://cvo.spongeservice.com.ua/images/touch/chrome-touch-icon-192x192.png">
<meta name=apple-mobile-web-app-capable content=yes>
<meta name=apple-mobile-web-app-status-bar-style content=black>
<meta name=apple-mobile-web-app-title content="Web Starter Kit">
<link rel=apple-touch-icon href="http://cvo.spongeservice.com.ua/images/touch/apple-touch-icon.png">
...
<link rel=stylesheet href="http://cvo.spongeservice.com.ua/styles/owl.carousel.min.css">
<link rel=stylesheet href="http://cvo.spongeservice.com.ua/styles/owl.theme.default.min.css">
{{ Html::script('js/frontend/url.js') }}
@include('frontend.includes.physics_script')
{{ Html::script('js/frontend/two.js') }}
<body class=card>
<section id=zones-mobal class="zone-col-modal item_cart show">
                        ...
                        <div class="wrap-card-params clearfix">
                                        ...
                                        @foreach($good->photos as $photo)
                                            <div class="wrap-curr-card-view hide">
                                                <div class="curr-card-view bg-white-marmur discount"
                                                     style="background-image: url(../../upload/images/{{ $photo->image }})"></div>
                                            </div>
                                        @endforeach
                                        ...
                                        <div class=wrap-card-varians-list>
                                            <ul class=card-varians-list>
                                                @foreach($good->photos as $photo)
                                                    ...
                                                    <li>
                                                        <div class="dot-card_item bg-white-marmur"
                                                             style="background-image: url(../../upload/images/{{ $photo->image }})"></div>
                                ...
                                <div class="wrap-price_buy it_cart">
                                    <div class="label-price_buy clearfix">
                                        ...
                                        <div class=card-to_stash>
                                            <svg id=card-to_stash class=svg-card-to_stash viewBox="0 0 110 128"
                                                 width=110 height=128>
                                                <polygon
                                                        points="71.6,103 14.3,103 0.7,65.3 85.4,65.3 85.4,69.7 7,69.7 17.4,98.6 71.6,98.6  "></polygon>
                                                <polygon
                                                        points="70.2,109.8 66.1,108.1 91.2,48 109.4,48 109.4,52.4 94.1,52.4  "></polygon>
                                                ...
                                                <g class=stash-arrow>
                                                    ...
                                                    <polygon
                                                            points="47.7,49.6 33.6,35.5 36.7,32.3 47.7,43.3 58.5,32.5 61.6,35.6  "></polygon>
                                                </g>
                                            </svg>
                                        </div>
                                    </div>
                            ...
                            <div class=wrap-card-params-right>
                                                ...
                                                <div class="card-zoneCat-list clearfix">
                                                    <div class=wrap-catal-zon_col>
                                                        <div class="swiper-wrapper overfl-h">
                                                            <div class="swiper-slide bg-white-marmur">
                                                                @foreach($good->collectionZone as $collectionZone)
                                                                    <div class=wrap-catal-zones><span class=catal-type>
                                                                            @foreach($collectionZone->mainZones as $mainZone)
                                                                                {{ $mainZone->title }}
                                                                            @endforeach
                                                                    </span>
                                                                    </div>
                                                                    <div class=wrap-catal-coll><span class=catal-coll>
                                            ...
                                            <div class="wrap-card-more-choices clearfix">
                                                <div class=item-standart-choice>
                                                    ...
                                                    <div class="cell-card-more-choices fin">
                                                        <div class="swiper-wrapper overfl-h">
                                                            <div class="swiper-slide fin_slide">
                                                                @foreach($good->finishTissues as $finishTissue)
                                                                    @if($finishTissue->parent->type == 'finish')
                                                                        <div class=nowrap-list-card_pr>{{ $finishTissue->title }}</div>
                                                                    @endif
                                                                @endforeach
                                                            </div>
                                                        </div>
                                                ...
                                                <div class=item-standart-choice>
                                                    ...
                                                    <div class="cell-card-more-choices tis">
                                                        <div class="swiper-wrapper overfl-h">
                                                            <div class="swiper-slide fin_slide">
                                                                @foreach($good->finishTissues as $finishTissue)
                                                                    @if($finishTissue->parent->type == 'tissue')
                                                                        {{ $finishTissue->title }},
                                                                    @endif
                                                                @endforeach
                                                            </div>
                                                ...
                                                <a href="{{ route('frontend.finish-tissue') }}"
                                                   class="card-mode-choice hov-colMain_clack">More
                                                    choices →</a></div>
                                        </div>
                                        <div class=wrap-card-dimensions>
                                            <div class="wrap-card-block-title clearfix">
                                                <div class=block_title-card>Dimensions</div>
                                                <div class=toggle-cent_inch><span
                                                            class="toggle-inner-length hov-colMain_clack active">Centimeters</span>
                                            ...
                                            <div class="wrap-table-dimensions clearfix">
                                                <ul class="wrap-dimensions-values clearfix">
                                                    ...
                                                    @foreach($good->dimensions as $key => $dimension)
                                                        @php($i = $key + 1)
                                                        <li>
                                                            <div class=dimensions-item-numb>{{ $i }}</div>
                                                            <div class=wrap-dim-swiper>
                                                                <div class=swiper-wrapper>
                                                                    <ul class="swiper-slide dimensions-values-item">
                                                                        <li>{{ $dimension->length }}
                                                                        <li>{{ $dimension->width }}
                                                                        <li>{{ $dimension->height }}
                                                                        <li>{{ $dimension->mattress }}
                                                                        <li>{{ $dimension->weight }} kg
                                                                    </ul>
                                                                    <ul class="swiper-slide dimensions-values-item">
                                                                        <li>2222
                                                                        <li>22/222
                                                ...
                                                <ul id=dimensions_values class="size-name no-desktop">
                                                    <li>194
                                                    <li>100/250
                                                    <li>93
                                                    <li>70x195x14
                                ...
                                <div class=wrap-share_social>
                                    ...
                                    <div class=wrap-share-soc_icons><a
                                                href="http://cvo.spongeservice.com.ua/facebook.com"
                                                class=share-social-link>
                                            <svg class=svg-share_social-icon>
                                                <use xmlns:xlink=http://www.w3.org/1999/xlink
                                                     xlink:href=images/icons/social.svg#fb></use>
                                            </svg>
                                        </a><a href="http://cvo.spongeservice.com.ua/instagram.com"
                                               class="share-social-link inst">
                                            <svg class=svg-share_social-icon>
                                                <use xmlns:xlink=http://www.w3.org/1999/xlink
                                                     xlink:href=images/icons/social.svg#instagram></use>
                                            </svg>
                                        </a><a href="http://cvo.spongeservice.com.ua/google.com"
                                               class=share-social-link>
                                            <svg class=svg-share_social-icon>
                                                <use xmlns:xlink=http://www.w3.org/1999/xlink
                                                     xlink:href=images/icons/social.svg#login_google_plus></use>
                                            </svg>
                                        </a><a href="http://cvo.spongeservice.com.ua/twitter.com"
                                               class=share-social-link>
                                            <svg class=svg-share_social-icon>
                                                <use xmlns:xlink=http://www.w3.org/1999/xlink
                                                     xlink:href=images/icons/social.svg#twitter></use>
                                            </svg>
                                        </a></div>
                                </div>
                            </div>
                            ...
                            <div class="swiper-wrapper overfl-h">
                                <div class="swiper-slide outer-slide bg-white-marmur">
                                    <div class=wrap-carousel-card>
                                        <div class=swiper-wrapper>
                                            @foreach($good->collectionZone as $collectionZone)
                                                <div class="swiper-slide card-modal-slide bg-white-marmur"><img
                                                            src="/upload/images/{{ $collectionZone->image }}"
                                                            alt=""></div>
                                            @endforeach
                                        </div>
                                    </div>
                            ...
                            <div class="wrap-swiper-related overfl-h">
                                <div class=swiper-wrapper>
                                    <div class="swiper-slide wrap-also-buy-items">
                                        <div class="new-products-right-item grid cart_item discount"><a
                                                    class=new-products-right-inner-item href="card-product.html#">
                                        ...
                                        <div class="new-products-right-item grid cart_item"><a
                                                    class=new-products-right-inner-item href="card-product.html#">
                                                <div class=product-img-table>
                                                    <div class="wrap-new-product-img bg-white-marmur"
                                                         style="background-image: url(http://cvo.spongeservice.com.ua/images/un_banner-1-2.jpg)"></div>
                                                </div>
                                                <div class=wrap-new-product-data>
                                                    <div class=product-code>#pr117</div>
                                                    <div class=product-name>Bench</div>
                                        ...
                                        <div class="new-products-right-item grid cart_item"><a
                                                ...
                                                <div class=product-img-table>
                                                    <div class="wrap-new-product-img bg-white-marmur"
                                                         style="background-image: url(http://cvo.spongeservice.com.ua/images/un_banner-1-3.jpg)"></div>
                                                </div>
                                                <div class=wrap-new-product-data>
                                                    <div class=product-code>#pr117</div>
                                                    <div class=product-name>Bench</div>
