                                ...
                                <div class="wrap-card-params-left">
                                    ...
                                    <div class="wrap-price_buy it_cart">
                                        <div class="label-price_buy clearfix">
                                            ...
                                            <div id="btn_to_stash" class="card-to_stash">
                                                  <svg id="circle-stash" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="-1 -1 62 62" class="svg-stash-circle">
                                                    <circle class="stroke" cx="30" cy="30" r="0"></circle>
                                                  </svg>
                                        ...
                                        <div class="wrap-carousel-card">
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="swiper-slide card-modal-slide bg-white-marmur">
                                                    <div class="slide-inner-bg" style="background-image: url('//cvo-dev.spongeservice.com.ua/upload/images/zone/original/{{$img}}")'></div>
                                                </div>
                                                @endif
                                                @endforeach
                                                @endif
