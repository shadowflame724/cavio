    ...
    <div class="wrap-banner-cont double">
        <h3 class=section-title>
            <div class="inner_wrap-double_title clearfix">
                <div class=wrap-title-item><a href="{{ route('frontend.zones') }}"
                                              class=inner-title-item>{{ trans('frontend.zones-collections.zones') }}</a></div>
                <div class=wrap-title-item><a href="{{ route('frontend.collections') }}" class="inner-title-item right active">{{ trans('frontend.zones-collections.collections') }}</a>
                </div>
            </div>
            ...
            @foreach($collections as $collection)
                @if($collection->banner == 0)
                    <div class="item-coll zon-col"><a
                                href="{{ route('frontend.collections.show', $collection) }}">
