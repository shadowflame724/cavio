    ...
    <div class=banner-center>
        <div class=wrap-banner-cont>
            ...
            <div class=banner-cont-read>
                <a href=#under-about-history class=anim-underline>{{ trans('frontend.about.continueReading') }} →</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="wrap-under-history clearfix">
        <div class=under-history-right>
            <div class="wrap-text-under-history-right anim-under-history">
                <div class=title-under-history>
                    @if (App::getLocale() == 'ru')
                        {!! $page->blocks->get(1)->title_ru !!}
                    @elseif(App::getLocale() == 'it')
                        {!! $page->blocks->get(1)->title_it !!}
                    @else
                        {!! $page->blocks->get(1)->title !!}
                    @endif
                </div>
                <div class="text-upline und-history">
                    @if (App::getLocale() == 'ru')
                        {!! $page->blocks->get(1)->body_ru !!}
                    @elseif(App::getLocale() == 'it')
                        {!! $page->blocks->get(1)->body_it !!}
                    @else
                        {!! $page->blocks->get(1)->body !!}
                    @endif
                </div>
            </div>
        ...
        <div class=under-history-left>
            ...
            <div class="text-upline und-history anim-under-history wrap-text-under-history-left">
                @if (App::getLocale() == 'ru')
                    {!! $page->blocks->get(2)->body_ru !!}
                @elseif(App::getLocale() == 'it')
                    {!! $page->blocks->get(2)->body_it !!}
                @else
...
<section id=about-philosofhy class=wrap-banner>
    <div class=banner-center>
        <div class=wrap-banner-cont>
            ...
            <div class=banner-cont-read>
                <a href=#under-about-philosofhy class=anim-underline>{{ trans('frontend.about.continueReading') }} →</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class=wrap-under-philosofhy>
        <div id=wrap-2-col-under-phil class="wrap-2-col-under-phil clearfix">
            ...
            <div class=column-under-phil>
                <br class=noDesktop>
                @if (App::getLocale() == 'ru')
                    {!! $page->blocks->get(5)->body_ru !!}
                @elseif(App::getLocale() == 'it')
                    {!! $page->blocks->get(5)->body_it !!}
                @else
        ...
        <div class=wrap-freedom-under-phil>
            ...
            <div class=freedom-under-phil-text>
                @if (App::getLocale() == 'ru')
                    {!! $page->blocks->get(6)->body_ru !!}
                @elseif(App::getLocale() == 'it')
                    {!! $page->blocks->get(6)->body_it !!}
                @else
    ...
    <div class=banner-center>
        <div class=wrap-banner-cont>
            ...
            <div class=wrap-banner-about-descr>
                <div class=banner-about-descr>
                    @if (App::getLocale() == 'ru')
                        {!! $page->blocks->get(7)->body_ru !!}
                    @elseif(App::getLocale() == 'it')
                        {!! $page->blocks->get(7)->body_it !!}
                    @else
                        {!! $page->blocks->get(7)->body !!}
                    @endif
                </div>
            </div>
            <div class=banner-cont-read>
                <a href=#under-about-mood class=anim-underline>{{ trans('frontend.about.continueReading')}} →</a>
            </div>
        </div>
    </div>
</section>
