...
// !PRESS-DESIGN
if(!(document.querySelector('body.press-design')) && !(document.querySelector('body.card'))) {

    scrollbars = !$('body').hasClass('about');
    prevFooterPos = $('footer').offset().top;
   ...
   * https://modernizr.com/download/?-backgroundblendmode-setclasses !*/
        ...
        if(!document.querySelector('html.mobile-platform')) {
            ...
            mainScroll.addListener(function(status){
                if (wavesBg_1) {
                    ...
                    else if (!document.querySelector('main.scrolling')) {
                        wavesBg_1.play();
                    }
                }
    ...
    document.addEventListener("DOMContentLoaded", function(){
        ...
        setTimeout(function(){   $('.short-nav-item:eq(1)').removeClass('hide')   }, 300);
        setTimeout(function(){   $('.wrap-login').removeClass('hide')             }, 600);
        setTimeout(function(){   $('.wrap-stash-ico').removeClass('hide')         }, 750);
...
if(document.querySelector('body.main')){
    ...
    $(window).on('scroll', function(event){
        if(!mainScroll){
            ...
            if(itemOffsetOurPhil !== true)  itemOffsetOurPhil = brPShopByColl - (window.innerHeight*0.7) - currScrolled;
            ...
            if(itemOffsetCollection < 0 && document.querySelector('#shop-by-collection.hide')){
                $('#shop-by-collection').removeClass('hide');
            }
    ...
    function scrollFunc(){
        mainScroll.addListener(function(status){
            ...
            if(mainScroll.isVisible( collCarous )){
                ...
                console.log(pxVisibledSwiper, dispUpperSwiper);
        ...
        if(window.innerWidth > 1024) {
            ...
            collectionCarousel = new Swiper('.collection-carousel', {
                ...
                onSlideChangeEnd: function () {
                    if(window.innerWidth > 1024) {
                        if(!beCollScrolled){
                            // $('.collection-carousel .item-coll.swiper-slide.visibHidden').removeClass('visibHidden');
                            // $('.zc-modal-swip-arrow.prev').addClass('showVisibOpasAnimCls');
                        }

                        $('.collection-carousel .item-coll.coll-swiper-arr').removeClass('coll-swiper-arr left right');
                        var collPrevSlides = $('.collection-carousel .item-coll.swiper-slide.swiper-slide-prev');
                        var collNextSlides = $('.collection-carousel .item-coll.swiper-slide.swiper-slide-next').next();
                ...
                onInit: function () {
                    if(window.innerWidth > 1024 && !beCollScrolled) {
                        // $('.collection-carousel .item-coll.swiper-slide.swiper-slide-prev').addClass('visibHidden');
                        // $('.collection-carousel .item-coll.swiper-slide.swiper-slide-next').next().addClass('coll-swiper-arr right');
                    }
    ...
    $('.new-products-right-inner-item').on('click', function(event){
        ...
        if(window.innerWidth <= 1024){ spaceBetween = 10; slidesPerView = 1.2; }
    ...
    $(document).ready(function(){
        ...
        // CLOSE MODAL THANK_YOU
        $(document).on('click', '#index-popup', function(event){
            if (!$(event.target).closest('.inner-zone-col-modal').length){
                $('#index-popup').toggleClass('hide show');
                $('body').toggleClass('overfl-h');
            }
        });
        $('#ok-ind_pop').on('click', function(e){
            e.preventDefault();
...
if(document.querySelector('body.about')){
    ...
    $(window).on('scroll', function(event){
        if(!mainScroll){
            ...
            var wrapImgUnderHistoryLeft = $($('.wrap-img-under-history-left')[0]).offset().top - (window.innerHeight*0.7) - currScrolled;
            var wrapTextUnderHistoryRight = $($('.wrap-text-under-history-right')[0]).offset().top - (window.innerHeight*0.7) - currScrolled;
            var wrapImgUnderHistoryRight = $($('.wrap-img-under-history-right')[0]).offset().top - (window.innerHeight*0.7) - currScrolled;
            var wrapTextUnderHistoryLeft = $($('.wrap-text-under-history-left')[0]).offset().top - (window.innerHeight*0.9) - currScrolled;

            var aboutPhilCont = $($('#about-philosofhy .banner-center')[0]).offset().top - (window.innerHeight*0.7) - currScrolled;
            var aboutMoodCont = $($('#about-mood .banner-center')[0]).offset().top - (window.innerHeight*0.7) - currScrolled;

            var itemOffsetAboutPhil = $($('#about-philosofhy')[0]).offset().top - (window.innerHeight*0.1) - currScrolled;
            var itemOffsetAboutMood = $($('#about-mood')[0]).offset().top - (window.innerHeight*0.1) - currScrolled;

            var wrap2ColUnderPhil = $($('#wrap-2-col-under-phil')[0]).offset().top - (window.innerHeight*0.6) - currScrolled;
            var itemOffsetAboutRomb = $($('#about-romb')[0]).offset().top - (window.innerHeight*0.7) - currScrolled;
            var itemOffsetMoodBig = $($('#inner-mood-big')[0]).offset().top - (window.innerHeight*0.7) - currScrolled;
...
if(document.querySelector('body.finish-tissue')){
    ...
    $('ul.zon-col-list-catal li a').on('click', function(e){
        ...
        var a = $(this.getAttribute('href')).offset().top;

        mainScroll.scrollTo(0, a-50+mainScroll.offset.y, a / 2);
        // $(this).closest('li').toggleClass('active');
...
if(document.querySelector('body.stash')){
    ...
    // CLOSE MODAL THANK_YOU
    $(document).on('click', '#modal-thank_you', function(event) {
        if (!$(event.target).closest('.inner-zone-col-modal').length) {
...
if(document.querySelector('body.showrooms')){
    ...
    $(document).ready(function () {
        dealersList = document.getElementById('dealers-list');

        carouselShowR = document.getElementById('carousel-show_r');
        ...
        mainShowR = document.getElementById('main-show_r');
        ...
        // var slidesPerView = 1.1;
        var spaceBetween = 240;
        if(window.innerWidth <= 1400){ spaceBetween = 150; }
        if(window.innerWidth <= 1024){ spaceBetween = 10;  }
    ...
    $(window).on('scroll', function(){
        if(!mainScroll){
            var currScrolled = $(document).scrollTop();
            var mainOffset = $('#about-romb').offset().top - currScrolled;

            console.log(currScrolled, mainOffset-window.innerHeight+$('#about-romb').height(), $('#about-romb').offset().top)
        }
    });
    ...
    function scrollFunc() {
        mainScroll.addListener(function(){
            ...
            if(mainScroll.isVisible( carouselShowR )){
                ...
                // console.log(pxVisibledSwiper, $(carouselShowR).height()*20/100);
                // console.log($(carouselShowR).height(), $(carouselShowR).height()*10/100);
            }
            // END carouselShowR ======
            ...
            if(mainScroll.isVisible( mainShowR )){
                ...
                if(dispUpperSwiper)  $(mainShowR).addClass("show");

                console.log(pxVisMainShowR, $(mainShowR).height()*150/100)
            }
            // END mainShowR ======
        })
    }
...
//  =====
    ...
    // swiperCard[0] = new Swiper('.wrap-swiper-card_price',{
    //   slidesPerView: 1,
    //   speed: 700,
    //   initialSlide: 1,
    //   followFinger: false,
    ...
    // swiperCard[1] = new Swiper('.cell-card-more-choices.fin',{
    //   slidesPerView: 1,
    //   // centeredSlides: true,
    //   speed: 700,
    //   initialSlide: 1,
    ...
    // swiperCard[2] = new Swiper('.cell-card-more-choices.tis',{
    //   slidesPerView: 1,
    //   // centeredSlides: true,
    //   speed: 700,
    //   initialSlide: 1,
    ...
    // });
    //
    // swiperCard[3] = new Swiper('.wrap-catal-zon_col',{
    //   slidesPerView: 1,
    //   speed: 700,
    //   initialSlide: 1,
    //   followFinger: false,
    ...
    swiperCard[4] = new Swiper('.wrap-bigest-swiper',{
        slidesPerView: 1,
        speed: 700,
        initialSlide: 1,
        autoHeight: true,
    ...
    swiperCard[5] = new Swiper('.wrap-swiper-related',{
        slidesPerView: 1,
        speed: 700,
        initialSlide: 1,
        autoHeight: true,
...
$('ul.wrap-dimensions-values li').on('click', function(e){
    ...
    var newListValue = $(this).find('ul.dimensions-values-item li');

    $('ul#dimensions_values li').each(function(key, el){
        $(el).text($(newListValue[key]).text());
    })
});
...
//  slide all swipers =========
    $('.wrap-swiper-card_price .wrap-card-price').eq(indexCurr).removeClass('active');
    $('.wrap-swiper-card_price .wrap-card-price').eq(indexNew).addClass('active');

    swiperCard.forEach(function(el){  el.slideTo(indexNew)  });
    swiperCardBig.slideTo(indexNew);
...
$('.toggle-cent_inch .toggle-inner-length').on('click', function(e){
    ...
    if($(this).index() == 0)  swiperDim.forEach(function(el){  el.slidePrev()  });
    else                      swiperDim.forEach(function(el){  el.slideNext()  });
});

// $('.item-fin_tis').addClass('hide');
// (function(){
//   $('.item-fin_tis').each(function(key){
//     var self = this;
//     setTimeout(function(){   self.classList.remove('hide')    }, 1500+100*key);
//   });
// })();
...
function initWaves() {
    ...
    var svgWaveWrap = document.querySelector('h3.section-title:not(.no-wave)');
